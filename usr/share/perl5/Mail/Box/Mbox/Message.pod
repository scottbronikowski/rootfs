...
=item Mail::Box::Mbox::Message-E<gt>B<new>(OPTIONS)
...
=item Mail::Box::Mbox::Message-E<gt>B<build>([MESSAGE|PART|BODY], CONTENT)

See L<Mail::Message::Construct::Build/"Constructing a message">

=item Mail::Box::Mbox::Message-E<gt>B<buildFromBody>(BODY, [HEAD], HEADERS)
...
=item Mail::Box::Mbox::Message-E<gt>B<read>(FILEHANDLE|SCALAR|REF-SCALAR|ARRAY-OF-LINES, OPTIONS)
...
=item Mail::Box::Mbox::Message-E<gt>B<replySubject>(STRING)
...
=item Mail::Box::Mbox::Message-E<gt>B<coerce>(MESSAGE, OPTIONS)
...
=item Mail::Box::Mbox::Message-E<gt>B<defaultTrace>([LEVEL]|[LOGLEVEL, TRACELEVEL]|[LEVEL, CALLBACK])
...
=item Mail::Box::Mbox::Message-E<gt>B<log>([LEVEL [,STRINGS]])

See L<Mail::Reporter/"Error handling">

=item $obj-E<gt>B<logPriority>(LEVEL)

=item Mail::Box::Mbox::Message-E<gt>B<logPriority>(LEVEL)
...
=item Mail::Box::Mbox::Message-E<gt>B<shortSize>([VALUE])
