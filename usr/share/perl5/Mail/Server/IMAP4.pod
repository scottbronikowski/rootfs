...
=item Mail::Server::IMAP4-E<gt>B<new>(OPTIONS)
...
=item Mail::Server::IMAP4-E<gt>B<defaultTrace>([LEVEL]|[LOGLEVEL, TRACELEVEL]|[LEVEL, CALLBACK])
...
=item Mail::Server::IMAP4-E<gt>B<log>([LEVEL [,STRINGS]])

See L<Mail::Reporter/"Error handling">

=item $obj-E<gt>B<logPriority>(LEVEL)

=item Mail::Server::IMAP4-E<gt>B<logPriority>(LEVEL)
