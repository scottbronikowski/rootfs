...
=item Mail::Message::TransferEnc::SevenBit-E<gt>B<new>(OPTIONS)
...
=item Mail::Message::TransferEnc::SevenBit-E<gt>B<addTransferEncoder>(TYPE, CLASS)
...
=item Mail::Message::TransferEnc::SevenBit-E<gt>B<defaultTrace>([LEVEL]|[LOGLEVEL, TRACELEVEL]|[LEVEL, CALLBACK])
...
=item Mail::Message::TransferEnc::SevenBit-E<gt>B<log>([LEVEL [,STRINGS]])

See L<Mail::Reporter/"Error handling">

=item $obj-E<gt>B<logPriority>(LEVEL)

=item Mail::Message::TransferEnc::SevenBit-E<gt>B<logPriority>(LEVEL)
