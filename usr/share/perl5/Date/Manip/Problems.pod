...
perl that I have tested starting at 5.10.  It has been tested on:
...
I have submitted a bug report (perlbug #78266). Until perl is fixed,
if you need to use Date::Manip in a persistent environment, you should
be aware of this.
...
A much more important problem is that versions 6.01 through 6.07 broke
