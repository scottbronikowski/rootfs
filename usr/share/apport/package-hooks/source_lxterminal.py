...
system_conf = os.path.join("usr","share","lxterminal")
home_conf = os.path.expanduser("~/.config/lxterminal/")
...
def add_info(report):
    ...
    if os.path.exists(os.path.join(home_conf,"lxterminal.conf")):
        report[report_config_home] = apport.hookutils.read_file(os.path.join(home_conf,"lxterminal.conf"))
    else:
        report[report_config_system] = apport.hookutils.read_file(os.path.join(system_conf,"lxterminal.conf"))
