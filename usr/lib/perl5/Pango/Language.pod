...
=head2 language = Pango::Language-E<gt>B<get_default> 

Since: pango 1.16

=head2 direction = Pango-E<gt>B<find_base_dir> ($text)
...
=head2 language = Pango::Language-E<gt>B<from_string> ($language)
