...
#define MCA_io_romio_COMPLETE_CONFIGURE_FLAGS " CFLAGS='-DNDEBUG -Wall -g -O2 -finline-functions -fno-strict-aliasing -pthread' CPPFLAGS='-D_FORTIFY_SOURCE=2 ' FFLAGS='-g -O2' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr --with-mpi=open_mpi --disable-aio"
...
#define OMPI_ARCH "arm-unknown-linux-gnueabihf"
...
#define OMPI_ASSEMBLY_ARCH OMPI_ARM

/* Format of assembly file */
#define OMPI_ASSEMBLY_FORMAT "default-.text-.globl-:--.L-#-1-1-1-1-1"
...
#define OPAL_PACKAGE_STRING "Open MPI buildd@sigbin Distribution"
