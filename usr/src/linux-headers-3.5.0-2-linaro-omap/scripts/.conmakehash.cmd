cmd_scripts/conmakehash := gcc -Wp,-MD,scripts/.conmakehash.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer   -I/usr/src/linux-headers-3.5.0-2-linaro-omap/tools/include  -o scripts/conmakehash scripts/conmakehash.c  
