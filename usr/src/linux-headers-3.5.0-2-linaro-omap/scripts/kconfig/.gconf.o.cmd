cmd_scripts/kconfig/gconf.o := gcc -Wp,-MD,scripts/kconfig/.gconf.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer   -DCURSES_LOC="<curses.h>" -DLOCALE  `pkg-config --cflags gtk+-2.0 gmodule-2.0 libglade-2.0` -Wno-missing-prototypes -c -o scripts/kconfig/gconf.o scripts/kconfig/gconf.c
