//C library for running Point Grey Chameleon cameras on Gumstix
...
unsigned int point_grey_init(void) {
  fc2Context context;
  //point_grey_set_white_balance(RED_BALANCE, BLUE_BALANCE);  //not on Chameleon?
