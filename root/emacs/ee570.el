(defdialect ee570 "EE570 Course Software" scheme
 ...
 (ilisp-load-init 'ee570 (expand-file-name "~/courses/purdue/ee570/fall2002/ee570-init")))
(setq ee570-program (expand-file-name "~/bin/i686-Linux-2.4.18-4_72smp/ee570"))
...
(defun scmman ()
 (interactive)
 (call-process "~/courses/purdue/ee570/fall2002/scmman" nil 0))

(defun handin ()
 (interactive)
 (let ((current-problem-set
	(call-process-region
	 (point-min) (point-max) "~/courses/purdue/ee570/fall2002/handin")))
...
(defun check-handin ()
 ...
 (let ((current-problem-set
	(call-process "~/courses/purdue/ee570/fall2002/check-handin" nil t)))
  (if (and (numberp current-problem-set) (> current-problem-set 1))
      (message "Problem set %d was successfully handed in."
	       (- current-problem-set 1))
      (error "Your problem set was NOT handed in."))))
