...
/* Define to allow the collector to disable execute permission of heap
   objects. */
...
#define PACKAGE_STRING "gc 7.2alpha4"
...
#define PACKAGE_VERSION "7.2alpha4"
