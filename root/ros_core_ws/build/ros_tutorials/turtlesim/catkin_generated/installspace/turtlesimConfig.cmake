...
if(NOT "/root/ros_core_ws/install/include" STREQUAL "")
  ...
  foreach(idir /root/ros_core_ws/install/include)
    ...
    elseif(IS_DIRECTORY /root/ros_core_ws/install/${idir})
      ...
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/install/${idir}'.  Ask the maintainer '${turtlesim_MAINTAINER}' to fix it.")
    endif()
