...
**
** Created: Tue Dec 18 00:42:55 2012
...
static const char qt_meta_stringdata_turtlesim__TurtleFrame[] = {
    "turtlesim::TurtleFrame\0onUpdate()\0\0"
};
...
const QMetaObjectExtraData turtlesim::TurtleFrame::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject turtlesim::TurtleFrame::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_turtlesim__TurtleFrame,
      qt_meta_data_turtlesim__TurtleFrame, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &turtlesim::TurtleFrame::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_turtlesim__TurtleFrame))
