...
if(NOT "/root/ros_core_ws/install/include" STREQUAL "")
  ...
  foreach(idir /root/ros_core_ws/install/include)
    ...
    elseif(IS_DIRECTORY /root/ros_core_ws/install/${idir})
      ...
      message(FATAL_ERROR "Project 'rosgraph_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/install/${idir}'.  Ask the maintainer '${rosgraph_msgs_MAINTAINER}' to fix it.")
    endif()
