...
if(NOT "" STREQUAL "")
  ...
  foreach(idir )
    ...
    elseif(IS_DIRECTORY /root/ros_core_ws/install/${idir})
      ...
      message(FATAL_ERROR "Project 'roscreate' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/install/${idir}'.  Ask the maintainer '${roscreate_MAINTAINER}' to fix it.")
    endif()
