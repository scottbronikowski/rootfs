...
if(NOT "/root/ros_core_ws/src/rospack/include" STREQUAL "")
  set(rospack_INCLUDE_DIRS "")
  foreach(idir /root/ros_core_ws/src/rospack/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/rospack/${idir})
      set(include /root/ros_core_ws/src/rospack/${idir})
    else()
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/rospack/${idir}'.  Ask the maintainer '${rospack_MAINTAINER}' to fix it.")
    endif()
