...
if(NOT "/root/ros_core_ws/src/ros_comm/tools/rosbag/include" STREQUAL "")
  set(rosbag_INCLUDE_DIRS "")
  foreach(idir /root/ros_core_ws/src/ros_comm/tools/rosbag/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/ros_comm/tools/rosbag/${idir})
      set(include /root/ros_core_ws/src/ros_comm/tools/rosbag/${idir})
    else()
      message(FATAL_ERROR "Project 'rosbag' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/ros_comm/tools/rosbag/${idir}'.  Ask the maintainer '${rosbag_MAINTAINER}' to fix it.")
    endif()
