...
if(NOT "/root/ros_core_ws/src/ros_comm/tools/rosconsole/include" STREQUAL "")
  set(rosconsole_INCLUDE_DIRS "")
  foreach(idir /root/ros_core_ws/src/ros_comm/tools/rosconsole/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/ros_comm/tools/rosconsole/${idir})
      set(include /root/ros_core_ws/src/ros_comm/tools/rosconsole/${idir})
    else()
      message(FATAL_ERROR "Project 'rosconsole' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/ros_comm/tools/rosconsole/${idir}'.  Ask the maintainer '${rosconsole_MAINTAINER}' to fix it.")
    endif()
    _list_append_unique(rosconsole_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosconsole")
...
foreach(extra /root/ros_core_ws/src/ros_comm/tools/rosconsole/cmake/rosconsole-extras.cmake)
  include(${extra})
endforeach()
