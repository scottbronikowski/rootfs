...
if(NOT "/root/ros_core_ws/devel/include" STREQUAL "")
  ...
  foreach(idir /root/ros_core_ws/devel/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/ros_comm/test/test_rosmaster/${idir})
      set(include /root/ros_core_ws/src/ros_comm/test/test_rosmaster/${idir})
    else()
      message(FATAL_ERROR "Project 'test_rosmaster' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/ros_comm/test/test_rosmaster/${idir}'.  Ask the maintainer '${test_rosmaster_MAINTAINER}' to fix it.")
    endif()
