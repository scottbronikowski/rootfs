...
if(NOT "/root/ros_core_ws/devel/include" STREQUAL "")
  ...
  foreach(idir /root/ros_core_ws/devel/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/ros_tutorials/turtlesim/${idir})
      set(include /root/ros_core_ws/src/ros_tutorials/turtlesim/${idir})
    else()
      message(FATAL_ERROR "Project 'turtlesim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/ros_tutorials/turtlesim/${idir}'.  Ask the maintainer '${turtlesim_MAINTAINER}' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND turtlesim_LIBRARIES ${${turtlesim_dep}_LIBRARIES})
  _list_append_unique(turtlesim_LIBRARY_DIRS ${${turtlesim_dep}_LIBRARY_DIRS})
endforeach()

if(turtlesim_LIBRARIES)
  _remove_duplicate_libraries(turtlesim_LIBRARIES turtlesim_LIBRARIES)
endif()
