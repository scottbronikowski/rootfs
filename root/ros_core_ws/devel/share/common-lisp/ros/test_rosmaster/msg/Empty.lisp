...
(cl:defmethod cl:initialize-instance :after ((m <Empty>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Empty)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_rosmaster-msg:<Empty> is deprecated: use test_rosmaster-msg:Empty instead.")))
