...
(cl:defmethod cl:initialize-instance :after ((m <LatencyMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LatencyMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<LatencyMessage> is deprecated: use roscpp-msg:LatencyMessage instead.")))

(cl:ensure-generic-function 'publish_time-val :lambda-list '(m))
(cl:defmethod publish_time-val ((m <LatencyMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:publish_time-val is deprecated.  Use roscpp-msg:publish_time instead.")
  (publish_time m))

(cl:ensure-generic-function 'receipt_time-val :lambda-list '(m))
(cl:defmethod receipt_time-val ((m <LatencyMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:receipt_time-val is deprecated.  Use roscpp-msg:receipt_time instead.")
  (receipt_time m))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <LatencyMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:count-val is deprecated.  Use roscpp-msg:count instead.")
  (count m))

(cl:ensure-generic-function 'thread_index-val :lambda-list '(m))
(cl:defmethod thread_index-val ((m <LatencyMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:thread_index-val is deprecated.  Use roscpp-msg:thread_index instead.")
  (thread_index m))

(cl:ensure-generic-function 'array-val :lambda-list '(m))
(cl:defmethod array-val ((m <LatencyMessage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:array-val is deprecated.  Use roscpp-msg:array instead.")
  (array m))
