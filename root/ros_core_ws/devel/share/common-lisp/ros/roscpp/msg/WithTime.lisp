...
(cl:defmethod cl:initialize-instance :after ((m <WithTime>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WithTime)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<WithTime> is deprecated: use roscpp-msg:WithTime instead.")))

(cl:ensure-generic-function 'my_time-val :lambda-list '(m))
(cl:defmethod my_time-val ((m <WithTime>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:my_time-val is deprecated.  Use roscpp-msg:my_time instead.")
  (my_time m))
