...
(cl:defmethod cl:initialize-instance :after ((m <FixedLengthStringArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FixedLengthStringArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<FixedLengthStringArray> is deprecated: use roscpp-msg:FixedLengthStringArray instead.")))
