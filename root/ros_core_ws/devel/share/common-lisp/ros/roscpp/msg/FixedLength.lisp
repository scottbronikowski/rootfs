...
(cl:defmethod cl:initialize-instance :after ((m <FixedLength>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FixedLength)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<FixedLength> is deprecated: use roscpp-msg:FixedLength instead.")))
...
(cl:defmethod b-val ((m <FixedLength>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:b-val is deprecated.  Use roscpp-msg:b instead.")
  (b m))
