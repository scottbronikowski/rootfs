...
(cl:defmethod cl:initialize-instance :after ((m <ThroughputMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ThroughputMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<ThroughputMessage> is deprecated: use roscpp-msg:ThroughputMessage instead.")))
