...
(cl:defmethod cl:initialize-instance :after ((m <WithDuration>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WithDuration)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<WithDuration> is deprecated: use roscpp-msg:WithDuration instead.")))

(cl:ensure-generic-function 'my_duration-val :lambda-list '(m))
(cl:defmethod my_duration-val ((m <WithDuration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:my_duration-val is deprecated.  Use roscpp-msg:my_duration instead.")
  (my_duration m))
