...
(cl:defclass <ArrayOfVariableLength> (roslisp-msg-protocol:ros-message)
  ((a
    :reader a
    :initarg :a
    :type (cl:vector roscpp-msg:VariableLength)
   :initform (cl:make-array 4 :element-type 'roscpp-msg:VariableLength :initial-element (cl:make-instance 'roscpp-msg:VariableLength))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArrayOfVariableLength>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArrayOfVariableLength)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<ArrayOfVariableLength> is deprecated: use roscpp-msg:ArrayOfVariableLength instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArrayOfVariableLength>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'a)))
    (cl:dotimes (i 4)
    (cl:setf (cl:aref vals i) (cl:make-instance 'roscpp-msg:VariableLength))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArrayOfVariableLength>)))
  ...
  (cl:format cl:nil "VariableLength[4] a~%================================================================================~%MSG: roscpp/VariableLength~%uint32[] a~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArrayOfVariableLength)))
  "Returns full string definition for message of type 'ArrayOfVariableLength"
  (cl:format cl:nil "VariableLength[4] a~%================================================================================~%MSG: roscpp/VariableLength~%uint32[] a~%~%~%"))
