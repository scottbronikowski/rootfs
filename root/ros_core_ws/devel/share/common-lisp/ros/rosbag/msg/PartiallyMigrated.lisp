...
(cl:defclass <PartiallyMigrated> (roslisp-msg-protocol:ros-message)
  ((field1
   ...
   (field2
    :reader field2
    :initarg :field2
    :type rosbag-msg:MigratedExplicit
    :initform (cl:make-instance 'rosbag-msg:MigratedExplicit))
   (field3
    :reader field3
    :initarg :field3
    :type cl:string
...
(cl:defmethod cl:initialize-instance :after ((m <PartiallyMigrated>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PartiallyMigrated)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<PartiallyMigrated> is deprecated: use rosbag-msg:PartiallyMigrated instead.")))

(cl:ensure-generic-function 'field1-val :lambda-list '(m))
(cl:defmethod field1-val ((m <PartiallyMigrated>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:field1-val is deprecated.  Use rosbag-msg:field1 instead.")
  (field1 m))

(cl:ensure-generic-function 'field2-val :lambda-list '(m))
(cl:defmethod field2-val ((m <PartiallyMigrated>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:field2-val is deprecated.  Use rosbag-msg:field2 instead.")
  (field2 m))

(cl:ensure-generic-function 'field3-val :lambda-list '(m))
(cl:defmethod field3-val ((m <PartiallyMigrated>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:field3-val is deprecated.  Use rosbag-msg:field3 instead.")
  (field3 m))

(cl:ensure-generic-function 'field5-val :lambda-list '(m))
(cl:defmethod field5-val ((m <PartiallyMigrated>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:field5-val is deprecated.  Use rosbag-msg:field5 instead.")
  (field5 m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PartiallyMigrated>)))
  ...
  (cl:format cl:nil "int32            field1 # 40~%MigratedExplicit field2 # (17, 58.2, \"aldfkja\", 82)~%string           field3 # \"radasdk\"~%float32          field5 # 63.4~%~%================================================================================~%MSG: rosbag/MigratedExplicit~%Header  header~%float32 afield2 #58.2~%string  combo_field3 #\"aldfkja 17\"~%int32   afield4 #82~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PartiallyMigrated)))
  "Returns full string definition for message of type 'PartiallyMigrated"
  (cl:format cl:nil "int32            field1 # 40~%MigratedExplicit field2 # (17, 58.2, \"aldfkja\", 82)~%string           field3 # \"radasdk\"~%float32          field5 # 63.4~%~%================================================================================~%MSG: rosbag/MigratedExplicit~%Header  header~%float32 afield2 #58.2~%string  combo_field3 #\"aldfkja 17\"~%int32   afield4 #82~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
