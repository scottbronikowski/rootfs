...
(cl:defmethod cl:initialize-instance :after ((m <MigratedImplicit>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MigratedImplicit)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<MigratedImplicit> is deprecated: use rosbag-msg:MigratedImplicit instead.")))
...
(cl:defmethod field4-val ((m <MigratedImplicit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:field4-val is deprecated.  Use rosbag-msg:field4 instead.")
  (field4 m))
