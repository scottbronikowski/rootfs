...
(cl:defmethod cl:initialize-instance :after ((m <SimpleMigrated>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SimpleMigrated)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<SimpleMigrated> is deprecated: use rosbag-msg:SimpleMigrated instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <SimpleMigrated>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:data-val is deprecated.  Use rosbag-msg:data instead.")
  (data m))
