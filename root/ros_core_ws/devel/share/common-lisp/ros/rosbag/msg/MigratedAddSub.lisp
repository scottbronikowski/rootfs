...
(cl:defclass <MigratedAddSub> (roslisp-msg-protocol:ros-message)
  ((field1
    :reader field1
    :initarg :field1
    :type rosbag-msg:Simple
    :initform (cl:make-instance 'rosbag-msg:Simple))
   (field2
    :reader field2
    :initarg :field2
    :type rosbag-msg:Simple
...
(cl:defmethod cl:initialize-instance :after ((m <MigratedAddSub>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MigratedAddSub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<MigratedAddSub> is deprecated: use rosbag-msg:MigratedAddSub instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MigratedAddSub>)))
  ...
  (cl:format cl:nil "Simple field1~%Simple field2~%================================================================================~%MSG: rosbag/Simple~%int32 field1 #42~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MigratedAddSub)))
  "Returns full string definition for message of type 'MigratedAddSub"
  (cl:format cl:nil "Simple field1~%Simple field2~%================================================================================~%MSG: rosbag/Simple~%int32 field1 #42~%~%"))
