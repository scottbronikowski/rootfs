...
(cl:defclass <MigratedMixed> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (field1
    :reader field1
    :initarg :field1
    :type rosbag-msg:MigratedImplicit
    :initform (cl:make-instance 'rosbag-msg:MigratedImplicit))
   (field2
    :reader field2
    :initarg :field2
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <MigratedMixed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MigratedMixed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<MigratedMixed> is deprecated: use rosbag-msg:MigratedMixed instead.")))
