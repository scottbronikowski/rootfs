...
if(NOT "" STREQUAL "")
  ...
  foreach(idir )
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/ros_comm/tools/rosnode/${idir})
      set(include /root/ros_core_ws/src/ros_comm/tools/rosnode/${idir})
    else()
      message(FATAL_ERROR "Project 'rosnode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/ros_comm/tools/rosnode/${idir}'.  Ask the maintainer '${rosnode_MAINTAINER}' to fix it.")
    endif()
