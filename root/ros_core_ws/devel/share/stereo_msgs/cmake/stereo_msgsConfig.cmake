...
if(NOT "/root/ros_core_ws/devel/include" STREQUAL "")
  ...
  foreach(idir /root/ros_core_ws/devel/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/common_msgs/stereo_msgs/${idir})
      set(include /root/ros_core_ws/src/common_msgs/stereo_msgs/${idir})
    else()
      message(FATAL_ERROR "Project 'stereo_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/common_msgs/stereo_msgs/${idir}'.  Ask the maintainer '${stereo_msgs_MAINTAINER}' to fix it.")
    endif()
