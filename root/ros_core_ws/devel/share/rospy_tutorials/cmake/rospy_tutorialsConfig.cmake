...
if(NOT "/root/ros_core_ws/devel/include" STREQUAL "")
  ...
  foreach(idir /root/ros_core_ws/devel/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/ros_tutorials/rospy_tutorials/${idir})
      set(include /root/ros_core_ws/src/ros_tutorials/rospy_tutorials/${idir})
    else()
      message(FATAL_ERROR "Project 'rospy_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/ros_tutorials/rospy_tutorials/${idir}'.  Ask the maintainer '${rospy_tutorials_MAINTAINER}' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND rospy_tutorials_LIBRARIES ${${rospy_tutorials_dep}_LIBRARIES})
  _list_append_unique(rospy_tutorials_LIBRARY_DIRS ${${rospy_tutorials_dep}_LIBRARY_DIRS})
endforeach()

if(rospy_tutorials_LIBRARIES)
  _remove_duplicate_libraries(rospy_tutorials_LIBRARIES rospy_tutorials_LIBRARIES)
endif()
