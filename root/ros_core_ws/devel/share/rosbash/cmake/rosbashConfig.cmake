...
if(NOT "" STREQUAL "")
  ...
  foreach(idir )
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/ros/tools/rosbash/${idir})
      set(include /root/ros_core_ws/src/ros/tools/rosbash/${idir})
    else()
      message(FATAL_ERROR "Project 'rosbash' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/ros/tools/rosbash/${idir}'.  Ask the maintainer '${rosbash_MAINTAINER}' to fix it.")
    endif()
