...
if(NOT "/root/ros_core_ws/devel/include;/root/ros_core_ws/src/actionlib/include;/usr/include" STREQUAL "")
  set(actionlib_INCLUDE_DIRS "")
  foreach(idir /root/ros_core_ws/devel/include;/root/ros_core_ws/src/actionlib/include;/usr/include)
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /root/ros_core_ws/src/actionlib/${idir})
      set(include /root/ros_core_ws/src/actionlib/${idir})
    else()
      message(FATAL_ERROR "Project 'actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ros_core_ws/src/actionlib/${idir}'.  Ask the maintainer '${actionlib_MAINTAINER}' to fix it.")
    endif()
    _list_append_unique(actionlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "actionlib;/usr/lib/libboost_thread-mt.so")
...
set(depends "actionlib_msgs;cpp_common;rosconsole;roscpp;roscpp_traits;rostime")
