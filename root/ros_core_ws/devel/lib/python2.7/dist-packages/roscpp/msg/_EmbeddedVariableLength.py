"""autogenerated by genpy from roscpp/EmbeddedVariableLength.msg. Do not edit."""
import sys
...
class EmbeddedVariableLength(genpy.Message):
  ...
  _type = "roscpp/EmbeddedVariableLength"
...
"""
  __slots__ = ['a']
  _slot_types = ['roscpp/VariableLength']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.a is None:
        self.a = roscpp.msg.VariableLength()
    else:
      self.a = roscpp.msg.VariableLength()
