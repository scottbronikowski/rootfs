...
if(CATKIN_TOPLEVEL_FIND_PACKAGE OR NOT CATKIN_TOPLEVEL)
  set(catkin_EXTRAS_DIR "/root/ros_core_ws/install/share/catkin/cmake")
...
foreach(component ${catkin_FIND_COMPONENTS})
  ...
  if(NOT ${component_lower} STREQUAL "catkin")
    ...
    # get search paths from all CMAKE_PREFIX_PATH (which includes devel space and all workspaces)
    set(paths "")
