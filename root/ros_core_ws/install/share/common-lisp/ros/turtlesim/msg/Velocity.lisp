...
(cl:defmethod cl:initialize-instance :after ((m <Velocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlesim-msg:<Velocity> is deprecated: use turtlesim-msg:Velocity instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim-msg:linear-val is deprecated.  Use turtlesim-msg:linear instead.")
  (linear m))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlesim-msg:angular-val is deprecated.  Use turtlesim-msg:angular instead.")
  (angular m))
