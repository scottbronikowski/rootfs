...
(cl:defmethod cl:initialize-instance :after ((m <Renamed4>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Renamed4)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<Renamed4> is deprecated: use rosbag-msg:Renamed4 instead.")))

(cl:ensure-generic-function 'foo-val :lambda-list '(m))
(cl:defmethod foo-val ((m <Renamed4>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:foo-val is deprecated.  Use rosbag-msg:foo instead.")
  (foo m))

(cl:ensure-generic-function 'bar-val :lambda-list '(m))
(cl:defmethod bar-val ((m <Renamed4>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:bar-val is deprecated.  Use rosbag-msg:bar instead.")
  (bar m))
