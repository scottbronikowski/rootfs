...
(cl:defmethod cl:initialize-instance :after ((m <Constants>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Constants)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<Constants> is deprecated: use rosbag-msg:Constants instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Constants>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:value-val is deprecated.  Use rosbag-msg:value instead.")
  (value m))
