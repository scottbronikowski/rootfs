...
(cl:defmethod cl:initialize-instance :after ((m <MigratedExplicit>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MigratedExplicit)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<MigratedExplicit> is deprecated: use rosbag-msg:MigratedExplicit instead.")))
...
(cl:defmethod afield2-val ((m <MigratedExplicit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:afield2-val is deprecated.  Use rosbag-msg:afield2 instead.")
  (afield2 m))

(cl:ensure-generic-function 'combo_field3-val :lambda-list '(m))
(cl:defmethod combo_field3-val ((m <MigratedExplicit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:combo_field3-val is deprecated.  Use rosbag-msg:combo_field3 instead.")
  (combo_field3 m))

(cl:ensure-generic-function 'afield4-val :lambda-list '(m))
(cl:defmethod afield4-val ((m <MigratedExplicit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rosbag-msg:afield4-val is deprecated.  Use rosbag-msg:afield4 instead.")
  (afield4 m))
