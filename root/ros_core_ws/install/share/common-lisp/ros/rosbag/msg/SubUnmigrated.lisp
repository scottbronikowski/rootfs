...
(cl:defclass <SubUnmigrated> (roslisp-msg-protocol:ros-message)
  ((field1
   ...
   (field2
    :reader field2
    :initarg :field2
    :type rosbag-msg:Unmigrated
    :initform (cl:make-instance 'rosbag-msg:Unmigrated)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SubUnmigrated>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubUnmigrated)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<SubUnmigrated> is deprecated: use rosbag-msg:SubUnmigrated instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SubUnmigrated>)))
  ...
  (cl:format cl:nil "int32      field1 # 92~%Unmigrated field2 # (12, \"uuiasjs\", 61.7)~%~%================================================================================~%MSG: rosbag/Unmigrated~%int32   field1 #12~%string  field2 #\"uuiasjs\"~%float32 field3 #61.7~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SubUnmigrated)))
  "Returns full string definition for message of type 'SubUnmigrated"
  (cl:format cl:nil "int32      field1 # 92~%Unmigrated field2 # (12, \"uuiasjs\", 61.7)~%~%================================================================================~%MSG: rosbag/Unmigrated~%int32   field1 #12~%string  field2 #\"uuiasjs\"~%float32 field3 #61.7~%~%"))
