...
(cl:defclass <Converged> (roslisp-msg-protocol:ros-message)
  ((field1
   ...
   (field2
    :reader field2
    :initarg :field2
    :type (cl:vector rosbag-msg:SimpleMigrated)
   :initform (cl:make-array 4 :element-type 'rosbag-msg:SimpleMigrated :initial-element (cl:make-instance 'rosbag-msg:SimpleMigrated))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Converged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Converged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rosbag-msg:<Converged> is deprecated: use rosbag-msg:Converged instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Converged>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'field2)))
    (cl:dotimes (i 4)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rosbag-msg:SimpleMigrated))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Converged>)))
  ...
  (cl:format cl:nil "float32[4]           field1 # [1.2, 3.4, 5.6, 7.8]~%SimpleMigrated[4]    field2 # [11, 22, 33, 44]~%================================================================================~%MSG: rosbag/SimpleMigrated~%int32 data # 42~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Converged)))
  "Returns full string definition for message of type 'Converged"
  (cl:format cl:nil "float32[4]           field1 # [1.2, 3.4, 5.6, 7.8]~%SimpleMigrated[4]    field2 # [11, 22, 33, 44]~%================================================================================~%MSG: rosbag/SimpleMigrated~%int32 data # 42~%~%"))
