...
(cl:defmethod cl:initialize-instance :after ((m <VariableLength>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VariableLength)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<VariableLength> is deprecated: use roscpp-msg:VariableLength instead.")))
