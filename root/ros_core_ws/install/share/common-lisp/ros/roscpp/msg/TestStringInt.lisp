...
(cl:defmethod cl:initialize-instance :after ((m <TestStringInt>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestStringInt)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<TestStringInt> is deprecated: use roscpp-msg:TestStringInt instead.")))

(cl:ensure-generic-function 'str-val :lambda-list '(m))
(cl:defmethod str-val ((m <TestStringInt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:str-val is deprecated.  Use roscpp-msg:str instead.")
  (str m))

(cl:ensure-generic-function 'counter-val :lambda-list '(m))
(cl:defmethod counter-val ((m <TestStringInt>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:counter-val is deprecated.  Use roscpp-msg:counter instead.")
  (counter m))
