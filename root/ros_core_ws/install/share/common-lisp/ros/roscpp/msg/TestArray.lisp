...
(cl:defmethod cl:initialize-instance :after ((m <TestArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<TestArray> is deprecated: use roscpp-msg:TestArray instead.")))
...
(cl:defmethod float_arr-val ((m <TestArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:float_arr-val is deprecated.  Use roscpp-msg:float_arr instead.")
  (float_arr m))
