...
(cl:defmethod cl:initialize-instance :after ((m <EmbeddedExternal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EmbeddedExternal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<EmbeddedExternal> is deprecated: use roscpp-msg:EmbeddedExternal instead.")))
