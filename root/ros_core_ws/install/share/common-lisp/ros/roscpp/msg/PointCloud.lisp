...
(cl:defclass <PointCloud> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (pts
    :reader pts
    :initarg :pts
    :type (cl:vector roscpp-msg:Point32)
   :initform (cl:make-array 0 :element-type 'roscpp-msg:Point32 :initial-element (cl:make-instance 'roscpp-msg:Point32)))
   (chan
    :reader chan
    :initarg :chan
    :type (cl:vector roscpp-msg:ChannelFloat32)
   :initform (cl:make-array 0 :element-type 'roscpp-msg:ChannelFloat32 :initial-element (cl:make-instance 'roscpp-msg:ChannelFloat32))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PointCloud>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointCloud)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<PointCloud> is deprecated: use roscpp-msg:PointCloud instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PointCloud>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:header-val is deprecated.  Use roscpp-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'pts-val :lambda-list '(m))
(cl:defmethod pts-val ((m <PointCloud>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:pts-val is deprecated.  Use roscpp-msg:pts instead.")
  (pts m))

(cl:ensure-generic-function 'chan-val :lambda-list '(m))
(cl:defmethod chan-val ((m <PointCloud>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:chan-val is deprecated.  Use roscpp-msg:chan instead.")
  (chan m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PointCloud>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'pts)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'roscpp-msg:Point32))
  ...
  (cl:let ((vals (cl:slot-value msg 'chan)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'roscpp-msg:ChannelFloat32))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
