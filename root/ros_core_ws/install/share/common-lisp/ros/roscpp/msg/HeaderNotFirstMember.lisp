...
(cl:defmethod cl:initialize-instance :after ((m <HeaderNotFirstMember>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HeaderNotFirstMember)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<HeaderNotFirstMember> is deprecated: use roscpp-msg:HeaderNotFirstMember instead.")))

(cl:ensure-generic-function 'foo-val :lambda-list '(m))
(cl:defmethod foo-val ((m <HeaderNotFirstMember>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:foo-val is deprecated.  Use roscpp-msg:foo instead.")
  (foo m))
