...
(cl:defclass <ArrayOfFixedLength> (roslisp-msg-protocol:ros-message)
  ((a
    :reader a
    :initarg :a
    :type (cl:vector roscpp-msg:FixedLength)
   :initform (cl:make-array 4 :element-type 'roscpp-msg:FixedLength :initial-element (cl:make-instance 'roscpp-msg:FixedLength))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ArrayOfFixedLength>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArrayOfFixedLength)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<ArrayOfFixedLength> is deprecated: use roscpp-msg:ArrayOfFixedLength instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ArrayOfFixedLength>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'a)))
    (cl:dotimes (i 4)
    (cl:setf (cl:aref vals i) (cl:make-instance 'roscpp-msg:FixedLength))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ArrayOfFixedLength>)))
  ...
  (cl:format cl:nil "# This comment has \"quotes\" in it~%FixedLength[4] a~%================================================================================~%MSG: roscpp/FixedLength~%uint32 a~%float32 b~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ArrayOfFixedLength)))
  "Returns full string definition for message of type 'ArrayOfFixedLength"
  (cl:format cl:nil "# This comment has \"quotes\" in it~%FixedLength[4] a~%================================================================================~%MSG: roscpp/FixedLength~%uint32 a~%float32 b~%~%~%"))
