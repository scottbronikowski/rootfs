...
(cl:defmethod cl:initialize-instance :after ((m <TestWithHeader>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TestWithHeader)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<TestWithHeader> is deprecated: use roscpp-msg:TestWithHeader instead.")))
