...
(cl:defmethod cl:initialize-instance :after ((m <ChannelFloat32>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChannelFloat32)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name roscpp-msg:<ChannelFloat32> is deprecated: use roscpp-msg:ChannelFloat32 instead.")))
...
(cl:defmethod vals-val ((m <ChannelFloat32>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader roscpp-msg:vals-val is deprecated.  Use roscpp-msg:vals instead.")
  (vals m))
