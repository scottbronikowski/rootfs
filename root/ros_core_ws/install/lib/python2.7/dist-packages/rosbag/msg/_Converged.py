"""autogenerated by genpy from rosbag/Converged.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['float32[4]','rosbag/SimpleMigrated[4]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.field2 is None:
        self.field2 = [rosbag.msg.SimpleMigrated(),rosbag.msg.SimpleMigrated(),rosbag.msg.SimpleMigrated(),rosbag.msg.SimpleMigrated()]
    else:
      self.field1 = [0.,0.,0.,0.]
      self.field2 = [rosbag.msg.SimpleMigrated(),rosbag.msg.SimpleMigrated(),rosbag.msg.SimpleMigrated(),rosbag.msg.SimpleMigrated()]
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.field2 = []
      for i in range(0, 4):
        val1 = rosbag.msg.SimpleMigrated()
        start = end
        end += 4
