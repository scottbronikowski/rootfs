...
git pull
git add -A
git commit -m "first commit from Lexar card"
git push
git pull
git status
...
git push
git pull
git commit -m "still trying Lexar commit"
/etc/init.d/ssh-tunnel.sh start
ps -ef | grep ssh
/etc/init.d/ssh-tunnel.sh stop
ssh -f -N -Y -R 22222:localhost:22 upplysingaoflun
ping google.com
ping -i 5 google.com
ls
git mergetool
...
git add -A
git status
git commit -m "4th try for Lexar"
git pull --rebase
git rebase --abort
git merge
